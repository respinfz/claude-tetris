...
- Una **pieza extra de reto**: la _tuerca_, un anillo de 3 × 3 con el centro hueco que aparece de
  forma ocasional (~1 de cada 15 piezas) y crea huecos difíciles de rellenar.
